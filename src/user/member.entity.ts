...
import { SubsPurchaseRecord } from '../purchaseRecord/subsPurchaseRecord.entity.js';

@Entity()
export class Member extends User{
    @OneToMany(() => CoursePurchaseRecord, (coursePurchaseRecord) => coursePurchaseRecord.member, {
        cascade: [Cascade.ALL],
        nullable: true })
        coursePurchaseRecord?: CoursePurchaseRecord

    @OneToMany(() => SubsPurchaseRecord, (subsPurchaseRecord) => subsPurchaseRecord.member, {
        cascade: [Cascade.ALL],
        nullable: true })
